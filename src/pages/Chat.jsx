        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Connect with other innovators, experts, and collaborators in the MindVaultIP community.
            </p>
          </motion.div>
        </div>
      </div>
                ...
                <>
                  ...
                  <div className="flex-1 p-6 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-semibold text-gray-400 mb-2">Chat with {selectedChat.name}</h3>
                  ...
                  <div className="p-6 border-t border-gray-700">
                    <div className="flex gap-3">
                      ...
                      />
                      <button className="px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg hover:from-green-600 hover:to-blue-700 transition-all duration-300">
